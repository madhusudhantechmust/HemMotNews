...
*/
class NCPrefsDialogObserver : public CDialogObserver
{
	public:
		/**
			Constructor.
		...
		*/
		NCPrefsDialogObserver(IPMUnknown* boss) : CDialogObserver(boss) {}

		/** Destructor. */
		virtual ~NCPrefsDialogObserver() {}
...
/* CREATE_PMINTERFACE
 ...
 application.
*/
CREATE_PMINTERFACE(NCPrefsDialogObserver, kNCPrefsDialogObserverImpl)

/* AutoAttach
*/
void NCPrefsDialogObserver::AutoAttach()
{
...
/* AutoDetach
*/
void NCPrefsDialogObserver::AutoDetach()
{
...
/* Update
*/
void NCPrefsDialogObserver::Update
(
	const ClassID& theChange,
	ISubject* theSubject,
	const PMIID& protocol,
